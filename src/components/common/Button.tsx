...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'cursor-pointer relative inline-flex items-center justify-center font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-primary-500 rounded-lg active:scale-95';
